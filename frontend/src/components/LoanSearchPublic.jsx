...
const LoanSearchPublic = () => {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            // Create search query from the form data
            const searchQuery = Object.values(searchData)
                .filter(value => value.trim() !== '')
                .join(' ');
            
            const response = await loanAPI.getApplications(searchQuery);
...
export default LoanSearchPublic;